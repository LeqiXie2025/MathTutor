...
'''
    ...
    # 写入文件
    files_to_create = {
        'agents/base_agent.py': base_agent_content,
        'agents/math_tutor_agent.py': math_tutor_agent_content,
        'agents/__init__.py': init_content,
